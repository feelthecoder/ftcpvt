...
import Header from "components/headers/logoheader";
...
export default ({ headingText = "Privacy Policy - Vid Downloader" }) => {
  ...
  return (
    <AnimationRevealPage>
      ...
      <Container>
        <ContentWithPaddingXl>
         ...
         <p>This privacy policy applies to the Vid Downloader app (hereby referred to as "Application") for mobile devices
           that was created by Vikas Kumar (hereby referred to as "Service Provider") as a Free service. This service is
        intended for use "AS IS".</p><br/>
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with
        certain personally identifiable information, including but not limited to vikaskumar20172210@gmail.com. The
    ...
    <div><br/>
        ...
        <ul>
            ...
            <li><a href="https://onesignal.com/privacy_policy" target="_blank" rel="noopener noreferrer">One Signal</a>
            </li>
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
        ...
        please contact them at vikaskumar20172210@gmail.com and they will respond in a reasonable time.</p>
    ...
    <div><br/>
        <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect
            ...
            provided us with personal information, please contact the Service Provider (vikaskumar20172210@gmail.com) so that
    ...
    <p>This privacy policy is effective as of 2024-05-10</p><br/><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
        please contact the Service Provider via email at vikaskumar20172210@gmail.com.</p>
    <hr/>
          </Text>
        </ContentWithPaddingXl>
      </Container>
