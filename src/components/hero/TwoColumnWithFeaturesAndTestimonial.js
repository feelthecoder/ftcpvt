...
export default ({
  heading = "Better, Faster and Quality Developement",
  description = "We are commited to develop top quality products for you & your brands so that you can achieve success in your business. Contact us now to get instant delivery of your products.",
  imageSrc = "https://www.jpsecurityagency.com/gallery/10.jpeg",
  imageDecoratorBlob = true,
  primaryButtonUrl = "/buttonforcontact form and requirements page",
  primaryButtonText = "Get Started",
  buttonRounded = true,
  features = ["Available All Over World", "Lifetime Free Technical Support"],
  testimonial = {
    quote: "It is really good opportunity to work with Mr. Vikas Kumar. His team provided good quality website and app for my business.",
    customerName: "Mr. Aman Pal",
    customerCompany: "JP Security Services"
  }
}) => {
