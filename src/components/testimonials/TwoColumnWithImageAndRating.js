...
export default ({
  ...
  description = "Client love us when we deploy products that meet their expectations. We have numerous client that are loving the way we work. Some of them has shown their love for us through their words.",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
      ...
      heading: "Best Support & Coordination",
      quote:
        "It was relly smooth working with team of feelthecoder as their services & products are reliable. We were having various modifications & need of technical support during our product developement which was efficiently handled by feelthecoder Team. Kudos to them.",
      customerName: "Lokesh Kumar",
      customerTitle: "Founder, Halwai.com"
    },
    {
      stars: 5,
      profileImageSrc:
        "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=512&h=512&q=80",
      heading: "Love the Experience and UI Interface !",
      quote:"We are grocery delivery company working Mathura, Uttar Pradesh. Our product SYS - Online Store is developed by feelthecoder team which is very effective and provide customers a user friendly interaface. Thanks to thier team.",
      customerName: "Rahul Saini",
      customerTitle: "Founder, SYS Mathura"
    }
  ]
}) => {
