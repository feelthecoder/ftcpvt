...
export default ({
  ...
  description = "We have professionals to complete your brand projects with various skill set. Our professionals are experienced in various Tech Stack like Flutter,MERN,MEAN & Mobile Development, AR/VR Developemnt,etc. Don't know what suits you best ? Connect with us to discuss solution product for your business.",
  primaryButtonText = "Learn More",
  primaryButtonUrl = "contact form requirement analysis",
  ...
  const defaultFeatures = [
    {
      ...
      description: "We have the best professionals/engineers across the globe just to work with you.",
